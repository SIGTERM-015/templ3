/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 8fd020dc6e991d5e9f012241472b9312)
// Runtime types generated with workerd@1.20260301.1 2026-03-07 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		R2: R2Bucket;
		DATABASE_URL: SecretsStoreSecret;
		PAYLOAD_SECRET: SecretsStoreSecret;
		R2_ACCESS_KEY_ID: SecretsStoreSecret;
		R2_BUCKET: SecretsStoreSecret;
		R2_SECRET_ACCESS_KEY: SecretsStoreSecret;
		SMTP_USER: SecretsStoreSecret;
		SMTP_PASS: SecretsStoreSecret;
		ASSETS: Fetcher;
		SITE_URL: "https://sigterm.vodka";
		DATABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_URL" | "DATABASE_URL" | "PAYLOAD_SECRET" | "NEXT_PUBLIC_SERVER_URL" | "R2_BUCKET" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_ENDPOINT" | "R2_REGION" | "SMTP_HOST" | "SMTP_PORT" | "SMTP_USER" | "SMTP_PASS" | "DATABASE_URL_PROD">> {}
}
